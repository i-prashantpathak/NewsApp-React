      ...
      <BrowserRouter>
        <div className="">
          ...
          <Routes>
            ...
            <Route path="/general" element={<News AppName={'NewsBubble'} key='general' newsApi="e56c12946e1548deb202af0f4f2b4e38" pageSize={pageSize}  category="general" countryCode="in" />}></Route>
            ...
            <Route path="/" element={<News AppName={'NewsBubble'} newsApi="e56c12946e1548deb202af0f4f2b4e38" pageSize={pageSize}  category="sports" countryCode="in" />}></Route>
